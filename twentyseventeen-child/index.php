    ...
    <div class="row">
        <div class="news-main-design col-12 col-sm-12 col-md-8 col-lg-9">
            ...
            <div class="main-small-design">
                ...
                <div class="main-small-new <?php if($i==2):?>alt <?php endif;?>col-12 col-sm-12 col-md-12 col-lg-4">
                    <?php if($i==2):?>
                    <div class="alt-inner">
                        <?php endif;?>
                    ...
                    if($categories[0]){
	                   if($i==2){echo '<a class="btn-link white" href="' . get_category_link($categories[0]->term_id ) . '">'. $categories[0]->name . '</a>';}
                        else {
                            ...
                            <div class="social-activity<?php if($i==2):?> white<?php endif;?>">
        ...
        $i=1;
                ...
                <?php $in_page[]=get_the_ID();?>
                   <div class="small-new <?php if($i==2 || $i==4):?>alt<?php endif;?>">
                        ...
                        <div class="social-activity<?php if($i==2 || $i==4):?> white<?php endif;?>">
                            <span><i class="far fa-thumbs-up"></i></span><span>123</span><span><i class="far fa-comment-dots"></i></span><span><?=$post->comment_count;?></span>
                        </div>
                        </div>
                        <?php if($i==2 || $i==4):?>
    ...
    <?php
        $i=1;
                ...
                <div class="long-new-inner">
                        ...
                        <div class="long-new-title <?php if($i==2 || $i==4):?>white<?php endif;?>"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></div>
                        <div class="social-activity<?php if($i==2 || $i==4):?> white<?php endif;?>">
                            <span><i class="far fa-thumbs-up"></i></span><span>123</span><span><i class="far fa-comment-dots"></i></span><span><?=$post->comment_count;?></span>
                        </div>
                        </div>
