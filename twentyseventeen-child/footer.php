        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-lg-7">
                    ...
                    <div class="site-name"><a href="/jurnal_1/">Журнал ТеремЪ</a></div>
                    <p class="description"><?php echo $redux_demo['footer-desc'];?></p>
                    <?php if($redux_demo['display_subscribe']):?>
                    <button type="button" class="btn-subscribe popmake-585"><?=$redux_demo['footer_subscribe_text'];?></button>
                    <?php endif;?>
                </div>
